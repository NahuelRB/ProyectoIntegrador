create table IF NOT EXISTS patient(id int auto_increment primary key,name varchar(255),lastname varchar (255),address varchar (50),dni varchar (20), date highdate);
